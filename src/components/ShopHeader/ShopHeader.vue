<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowIntroduce=true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowCoupon=true">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowIntroduce">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="isShowIntroduce=false">
    ...
    <transition name="move">
      <div class="activity-sheet" v-show="isShowCoupon">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="isShowCoupon=false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
